...
function Navbar() {
    return ( 
          <nav className="p-4 mb-12 flex justify-between">
            <Link href='/'><h1 className="font-burtons sm:text-base hover:text-teal-200 text-xl">joelchadambuka</h1></Link>
            <ul className="flex items-center">
              ...
              <li>
                <Link
                  className=" px-2 py-2 border-none rounded-md ml-8 hover:text-teal-200"
                  href='/contact'
                >
                    Contact Us
                </Link>
