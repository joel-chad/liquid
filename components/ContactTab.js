...
export default function ContactTab(){
    return(
        <section className="relative pb-6 md:py-4 overflow-hidden">
        <img className="absolute top-0 left-0 md:mt-6" src="saturn-assets/images/contact/dots-side-1.svg" alt=""/>
        <img className="absolute bottom-0 right-0 mb-2 lg:mb-24" src="saturn-assets/images/contact/dots-side-2.svg" alt=""/>
        <div className="relative container px-2 mx-auto">
          <div className="max-w-2xl mx-auto mb-9 text-center">
            <span className="inline-block py-1 px-3 mb-2 text-xs font-semibold text-green-900 bg-green-50 rounded-full">READY TO SUPPORT?</span>
            ...
            <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10 mb-10 md:mb-0">
              <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
                <div className="max-w-2xs mx-auto text-center">
                  ...
                  <span className="block text-sm text-green-900 mb-8">hello@greensales.com</span>
                  <a className="relative group inline-block py-4 px-6 text-white font-semibold bg-green-900 rounded-md overflow-hidden" href="#">
            ...
            <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10">
              <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
                <div className="max-w-2xs mx-auto text-center">
                  ...
                  <p className="text-gray-500 mb-3">Contact us to seek help from us, we will help you as soon as possible</p>
                  <span className="block text-sm text-green-900 mb-8">+08 128 903427</span>
                  <a className="relative group inline-block py-4 px-6 text-white font-semibold bg-green-900 rounded-md overflow-hidden" href="#">
                    <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
