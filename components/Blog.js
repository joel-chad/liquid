...
export default function Blog(){
    return(
        ...
        <div className="relative container px-2 mx-auto">
          <div className="max-w-2xl mx-auto mb-1 text-center">
            <span className="inline-block py-1 px-3 mb-1 text-xs font-semibold text-green-900 bg-green-50 rounded-full">OUR BLOG</span>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="py-3 border-t-2 border-gray-100">
              <div className="flex flex-wrap lg:flex-nowrap items-center">
                <div className="w-full lg:w-auto px-2 mb-4 lg:mb-0">
                ...
                <div className="w-full lg:w-9/12 px-4 mb-4 lg:mb-0">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-base font-semibold text-gray-900">Consectures Dummy Content Velit officia consequat duis enim velit mollit adipsing</p>
                  </div>
                </div>
                <div className="w-full lg:w-auto px-2 ml-auto text-right">
                  <a className="inline-flex items-center text-sm font-semibold text-green-900 hover:text-gray-900" href="#">
            ...
            <div className="py-6 border-t-2 border-gray-100">
              <div className="flex flex-wrap lg:flex-nowrap items-center">
                ...
                <div className="w-full lg:w-9/12 px-4 mb-5 lg:mb-0">
                  <div className="max-w-2xl">
                    <span className="block text-gray-400 mb-1">Jul 20, 2022</span>
                    <p className="text-base font-semibold text-gray-900">Consectures Dummy Content Velit officia consequat duis enim velit mollit adipsing</p>
                  </div>
            ...
            <div className="lg:py-12 md:py-5 border-t-2 border-gray-100">
              <div className="flex flex-wrap lg:flex-nowrap items-center">
                  ...
                  <a className="inline-flex items-center text-sm font-semibold text-green-900 hover:text-gray-900" href="#">
                    ...
                    <svg className="animate-bounce" width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="pt-6 border-t-2 border-gray-100 text-center">
                          <a className="relative group inline-block py-2 px-3 font-semibold text-green-900 hover:text-green-50 rounded-md text-base bg-green-50 transition duration-300 overflow-hidden" href="#">
