...
import user from '../public/contact.png'   
            ...
            <div className="flex flex-">
              <div className="w-full md:w-1/2 pt-6 mb-10 md:mb-0">
                <h3 className="mb-1 text-2xl font-bold text-white">
                  <span className="text-green-300">Need any help?</span>
                  <span>Call Us</span>
                </h3>
                <p className="mb-8 md:mb-16 text-sm font-medium text-green-100">We will make sure to help you</p>
                <Link className="flex items-center text-white font-medium" href="/contact">
              ...
              <div className="w-full md:w-1/2 flex items-center">
                <Image  className="mx-auto h-48 w-56" src={user} alt=""/>
              </div>
            </div>
          </div>
        </div>
