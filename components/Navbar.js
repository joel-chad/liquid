      ...
      <div className="bg-white shadow">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-green-600" viewBox="0 0 24 24">
            ...
            <Link href="/" className="text-gray-800 items-center pr-3 text-sm font-semibold hover:text-green-600">Home</Link>
              <Link href="/projects" className="text-gray-800 pr-3 text-sm font-semibold hover:text-green-600">Products</Link>
              <Link href="/about" className="text-gray-800 pr-3 text-sm font-semibold hover:text-green-600">About</Link>
              <Link href="/contact" className="text-gray-800 text-sm font-semibold hover:text-green-600">Contact</Link>
            </div>
            ...
            <div className="sm:hidden cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-green-600" viewBox="0 0 24 24">
          ...
          <div className="block sm:hidden bg-white border-t-2 py-2">
            <div className="flex flex-col">
              <Link href="/" className="text-gray-800 text-sm font-semibold hover:text-green-600 mb-1">Home</Link>
              <Link href="/projects" className="text-gray-800 text-sm font-semibold hover:text-green-600 mb-1">Products</Link>
              <Link href="/about" className="text-gray-800 text-sm font-semibold hover:text-green-600 mb-1">About</Link>
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-600 mb-1">Pricing</a>
