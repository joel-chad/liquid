      ...
      <div className="bg-white shadow">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <Link href="/" className="text-gray-800 items-center pr-3 text-sm font-semibold hover:text-purple-600">Home</Link>
              <Link href="/projects" className="text-gray-800 pr-3 text-sm font-semibold hover:text-purple-600">Products</Link>
              <Link href="/about" className="text-gray-800 pr-3 text-sm font-semibold hover:text-purple-600">About</Link>
              <Link href="/contact" className="text-gray-800 text-sm font-semibold hover:text-purple-600">Contact</Link>
            </div>
    
            <div className="hidden sm:flex sm:items-center">
              <Link href="/signin" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Sign in</Link>
          ...
          <div className="block sm:hidden bg-white border-t-2 py-2">
            <div className="flex flex-col">
              <Link href="/" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Home</Link>
              <Link href="/projects" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Products</Link>
              <Link href="/about" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">About</Link>
