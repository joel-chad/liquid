      ...
      <div className="bg-white shadow">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#00A651]" viewBox="0 0 24 24">
            ...
            <Link href="/" className="text-gray-800 items-center pr-3 text-sm font-semibold hover:text-[#00A651]">Home</Link>
              ...
              <Link href="/how" className="text-gray-800 pr-3 text-sm font-semibold hover:text-[#00A651]">Plans</Link>
            ...
            <div className="hidden sm:flex sm:items-center">
              ...
              <Link href="/register" className="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-[#00A651] hover:border-green-600">Register</Link>
            </div>
    
            <div className="sm:hidden cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#00A651]" viewBox="0 0 24 24">
          ...
          <div className="block sm:hidden bg-white border-t-2 py-2">
            <div className="flex flex-col">
              ...
              <Link href="/how" className="text-gray-800 text-sm font-semibold hover:text-[#00A651] mb-1">Plans</Link>
