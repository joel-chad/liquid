...
export default function OtherDetails() {
    return (
      <main className="flex flex-col w-4/5 py-4 lg:w-2/4 bg-white rounded-tl-md rounded-br-md shadow-md justify-center md:p-2 lg:p-10">
        {/* <h1 className=''>Personal Details</h1> */}
        {/* <label htmlFor="name">First Name</label> */}
        <h3 className="font-semibold text-center py-3">Other Details</h3>
