...
export default function Contact() {
  return (
    <section className="pb-12">
      <div className="relative z-10 bg-[#92D050] p-4 md:p-10 lg:p-20 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            ...
            <div className="icons-container inline-flex flex-col my-10">
              <div className="flex flex-row items-center space-x-6 rounded-md border border-green-300 hover:border hover:border-green-500 p-4">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-telephone-fill h-4 w-4 text-[#FF9000]-400"
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
              ...
              <div className="flex flex-row items-center space-x-6 rounded-md border border-green-300 hover:border hover:border-green-500 p-4">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-envelope-fill h-4 w-4 text-[#FF9000]-400"
                  viewBox="0 0 16 16"
                >
              ...
              <div className="flex flex-row items-center space-x-6 rounded-md border border-green-300 hover:border hover:border-green-500 p-4">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-pin-fill h-4 w-4 text-[FF9000]-400"
                  viewBox="0 0 16 16"
                >
            ...
            <div className="social-icons flex flex-row space-x-8">
              <a
                ...
                className="h-10 w-10 rounded-full hover:bg-[#00A651] flex items-center justify-center cursor-pointer"
              >
                <svg
                  width="24"
                  height="24"
          ...
          <form className="form rounded-lg bg-white p-4 flex flex-col">
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-green-500 text- to-lime-200 rounded-md w-1/2 mx-4 mt-8 py-2 hover:bg-gradient-to-l text-gray-50 text-xs font-bold"
            >
              Send Message
            </button>
          </form>
