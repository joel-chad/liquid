...
export default function FAQ(){
    return(
      <Container>
        ...
        <button className="flex mb-4 pb-4 group w-full items-start justify-between border-b border-gray-100 text-left">
          <div className="max-w-xl pr-5">
            <h3 className="text-base font-semibold text-black group-hover:text-green-900">How was the license?</h3>
            <p className="hidden group-hover:block mt-3 text-sm text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus. Eros amet at lectus ac ac nibh dignissim.</p>
          </div>
          <div className="pt-1">
        ...
        <button className="flex mb-4 pb-4 group w-full items-start justify-between border-b border-gray-100 text-left">
          <div className="max-w-xl pr-5">
            <h3 className="text-base font-semibold text-black group-hover:text-green-900">How much we can buy this marvelous product?</h3>
            <p className="hidden group-hover:block mt-3 text-sm text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus. Eros amet at lectus ac ac nibh dignissim.</p>
          </div>
          <div className="pt-1">
            <span className="hidden group-hover:block">
        ...
        <button className="flex group w-full items-start justify-between text-left">
          <div className="max-w-xl pr-5">
            <h3 className="text-base font-semibold text-black group-hover:text-green-900">Do you have any terms &amp; conditions?</h3>
            <p className="hidden group-hover:block mt-3 text-sm text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus. Eros amet at lectus ac ac nibh dignissim.</p>
          </div>
          <div className="pt-1">
            <span className="hidden group-hover:block">
